...
| <a name="input_ignore_changes_action"></a> [ignore\_changes\_action](#input\_ignore\_changes\_action) | Ignore changes in action, useful for Blue Green Deployment | `bool` | `false` | no |
